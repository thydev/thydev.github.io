...
var graphicAssets = {
    ship: {
        URL: assetUrl + 'ship3.png',
        name: 'ship',
        width: 60,
        height: 60
    },
    bullet: {
        URL: assetUrl + 'bullet3.png',
        name: 'bullet'
    },

    asteroidLarge: {
        URL: assetUrl + 'asteroidLarge2.png',
        name: 'asteroidLarge'
    },
    asteroidMedium: {
        URL: assetUrl + 'asteroidMedium2.png',
        name: 'asteroidMedium'
    },
    asteroidSmall: {
        URL: assetUrl + 'asteroidSmall2.png',
        name: 'asteroidSmall'
    },

    background: {
        URL: assetUrl + 'background3.jpg',
        name: 'background'
    },
    explosionLarge: {
        URL: assetUrl + 'explosionLarge.png',
        name: 'explosionLarge',
        width: 64,
        height: 64,
        frames: 8
    ...
    explosionMedium: {
        URL: assetUrl + 'explosionMedium.png',
    ...
    explosionSmall: {
        URL: assetUrl + 'explosionSmall.png',
        name: 'explosionSmall',
        width: 41,
        height: 41,
        frames: 8
...
var soundAssets = {
    fire: {
        URL: [assetUrl + 'fire.m4a', assetUrl + 'fire.ogg'],
        name: 'fire'
    },
    destroyed: {
        URL: [assetUrl + 'destroyed.m4a', assetUrl + 'destroyed.ogg'],
        name: 'destroyed'
    },
};
